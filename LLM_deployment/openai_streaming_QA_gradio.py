...
base_url = "http://127.0.0.1:5009/v1/" # 来自openai_api_server
...
def simple_chat(query, file_path, chatbot, history, use_stream=True):
    global selected_file_path
    ...
    # logger.info(f"file_path:{file_path}")
    # logger.info(f"select file path:{selected_file_path}")
